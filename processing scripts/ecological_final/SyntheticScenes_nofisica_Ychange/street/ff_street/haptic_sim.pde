        ...
        if ((rDiff.mag() < s.radius)) {
          if (!s.active) {
            ...
            if (circlenum == 1 && ping){
              ...
              person3.play();
              println("______  __IN____");
              println(circletouch);
              println(circlenum);
              println("______ IN ______");
              ping = false;
              ...
              person5.play();
              ping = false;
            }else if (circlenum == 6 && ping ){
              person6.play();
              ping = false;
            }else if (circlenum == 7 && ping ){
              car.play();
              ping = false;
            }else if (circlenum == 8 && ping ){
              person2.play();
              ping = false;
            }
          }
          ...
          if (s.active) {
            s.active = false;
            s.offsetFlag = true;
            println("______ out ______");
            println(circletouch);
            println(circlenum);
            println("______ out ______");
            ping = true;
            //if (circlenum == circletouch) {
            //  inobject = false;
            //  ping = true;
            //}
          }
