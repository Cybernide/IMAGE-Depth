...
long currTime, lastTime, timeDiff = 0;
long timeDiffMin = 20000000;
...
HapticSwatch[] objects = {
  ...
  new HapticSwatch(-0.075 +(0.1*x4), 0.125 - (0.075 *z4), 0.007),
  new HapticSwatch(-0.075 +(0.1*x5), 0.125 - (0.075 *z5), 0.007),
  new HapticSwatch(-0.075 +(0.1*x6), 0.125 - (0.075 *z6), 0.007),
  new HapticSwatch(-0.075 +(0.1*x7), 0.125 - (0.075 *z7), 0.007),
  new HapticSwatch(-0.075 +(0.1*x8), 0.125 - (0.075 *z8), 0.007)
};
...
void setup() {
  ...
  if (lang == Language.english){
    person1 = new SoundFile(this, "person1.wav");
    person2 = new SoundFile(this, "person2.wav");
    person3 = new SoundFile(this, "person3.wav");
    person4 = new SoundFile(this, "person4.wav");
    person5 = new SoundFile(this, "person5.wav");
    person6 = new SoundFile(this, "person6.wav");
    car = new SoundFile(this, "car.wav");
    bench = new SoundFile(this, "bench.wav");
  } else {
    person1 = new SoundFile(this, "personne1.wav");
    person2 = new SoundFile(this, "personne2.wav");
    person3 = new SoundFile(this, "personne3.wav");
    person4 = new SoundFile(this, "personne4.wav");
    person5 = new SoundFile(this, "personne5.wav");
    person6 = new SoundFile(this, "personne6.wav");
    car = new SoundFile(this, "voiture.wav");
    bench = new SoundFile(this, "banc.wav");
  }
