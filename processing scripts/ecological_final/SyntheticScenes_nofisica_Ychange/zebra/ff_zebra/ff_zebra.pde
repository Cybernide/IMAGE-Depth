...
void setup() {
  ...
  if (lang == Language.english){
    zebra1 = new SoundFile(this, "zebra1.wav");
    zebra2 = new SoundFile(this, "zebra2.wav");
    zebra3 = new SoundFile(this, "zebra3.wav");
    zebra4 = new SoundFile(this, "zebra4.wav");
    zebra5 = new SoundFile(this, "zebra5.wav");
  } else {
    zebra1 = new SoundFile(this, "zebre1.wav");
    zebra2 = new SoundFile(this, "zebre2.wav");
    zebra3 = new SoundFile(this, "zebre3.wav");
    zebra4 = new SoundFile(this, "zebre4.wav");
    zebra5 = new SoundFile(this, "zebre5.wav");
  }  
  ///*table setup */
  log = new Table();
  log.addColumn("time");
