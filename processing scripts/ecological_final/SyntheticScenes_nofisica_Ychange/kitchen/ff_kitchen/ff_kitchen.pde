...
void setup() {
  ...
  if (lang == Language.english){
    ...
    chair1 = new SoundFile(this, "chair1.wav");
    chair2 = new SoundFile(this, "chair2.wav");
    chair3 = new SoundFile(this, "chair3.wav");
    fridge = new SoundFile(this, "refridgerator.wav");
    dinningtable = new SoundFile(this, "dinningtable.wav");
  } else {
    println("French language selected");
    chair1 = new SoundFile(this, "chaise1.wav");
    chair2 = new SoundFile(this, "chaise2.wav");
    chair3 = new SoundFile(this, "chaise3.wav");
    fridge = new SoundFile(this, "refrigerateur.wav");
    dinningtable = new SoundFile(this, "table.wav");
  }
  ///*table setup */
  log = new Table();
  log.addColumn("time");
