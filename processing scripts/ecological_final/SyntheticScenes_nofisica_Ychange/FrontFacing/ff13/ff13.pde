...
void setup() {
  ...
  /* ping definitions */
  ping1 = new SoundFile(this, "../../Top-down/tt13/zping1.mp3");
  ping2 = new SoundFile(this, "../../Top-down/tt13/zping2.mp3");
  ping3 = new SoundFile(this, "../../Top-down/tt13/zping3.mp3");
  ping4 = new SoundFile(this, "../../Top-down/tt13/zping4.mp3");
