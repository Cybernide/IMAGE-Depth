...
SoundFile chair;
SoundFile pottedPlant1;
SoundFile pottedPlant2;
SoundFile pottedPlant3;
SoundFile person;
SoundFile cup;
SoundFile laptop;
...
void setup() {
  ...
  if (lang == Language.english){
    chair = new SoundFile(this, "chair.wav");
    pottedPlant1 = new SoundFile(this, "pottedplant1.wav");
    pottedPlant2 = new SoundFile(this, "pottedplant2.wav");
    pottedPlant3 = new SoundFile(this, "pottedplant3.wav");
    person = new SoundFile(this, "person.wav");
    cup = new SoundFile(this, "cup.wav");
    laptop = new SoundFile(this, "laptop.wav");
  } else {
    chair = new SoundFile(this, "chaise.wav");
    pottedPlant1 = new SoundFile(this, "planteenpot1.wav");
    pottedPlant2 = new SoundFile(this, "planteenpot2.wav");
    pottedPlant3 = new SoundFile(this, "planteenpot3.wav");
    person = new SoundFile(this, "personne.wav");
    cup = new SoundFile(this, "tasse.wav");
    laptop = new SoundFile(this, "ordinateurportable.wav");
  }
