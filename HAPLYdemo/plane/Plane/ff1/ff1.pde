...
HapticSwatch[] people = {
  new HapticSwatch(-0.1 +(0.155*p_x1), 0.135 - (0.105 * (1-p_y1)), 0.007), // object radius is 0.005 and end effector radius is 0.002. Rather than increase the end effector size, simply increased the object sizes to match
  new HapticSwatch(-0.1 +(0.155*p_x2), 0.135 - (0.105 *(1-p_y2)), 0.007),
  new HapticSwatch(-0.1 +(0.155*p_x3), 0.135 - (0.105 * (1-p_y3)), 0.007), // object radius is 0.005 and end effector radius is 0.002. Rather than increase the end effector size, simply increased the object sizes to match
  new HapticSwatch(-0.1 +(0.155*p_x4), 0.135 - (0.105 *(1-p_y4)), 0.007)
};

HapticSwatch[] airplanes = {
  new HapticSwatch(-0.1 +(0.155*a_x1), 0.135 - (0.105 * (1-a_y1)), 0.007) // object radius is 0.005 and end effector radius is 0.002. Rather than increase the end effector size, simply increased the object sizes to match
};
...
void setup() {
  ...
  backImage = loadImage("plane.jpg");
  backImage.resize(700, 450);
  
  /* ping definitions */
  ping1 = new SoundFile(this, "../tt1/zping1.mp3");
  ping2 = new SoundFile(this, "../tt1/zping2.mp3");
  ping3 = new SoundFile(this, "../tt1/zping3.mp3");
  ping4 = new SoundFile(this, "../tt1/zping4.mp3");
  ping5 = new SoundFile(this, "../tt1/zping5.mp3");
