...
void setup() {
  ...
  if (lang == Language.english){
    ball1 = new SoundFile(this, "sportsball1.wav");
    ball2 = new SoundFile(this, "sportsball2.wav");
    ...
    ball1 = new SoundFile(this, "ballondesport1.wav");
    ball2 = new SoundFile(this, "ballondesport2.wav");
